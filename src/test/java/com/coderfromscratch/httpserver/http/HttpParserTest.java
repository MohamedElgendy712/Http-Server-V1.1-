...
class HttpParserTest {
    ...
    void parseHttpRequest() {
        ...
        assertEquals(request.getRquestTarget() , "/");
    ...
    @Test
    void parseHttpRequestLineInvNumItems() {
    ...
    @Test
    void parseEmptyHttpRequestLine() {
    ...
    void parseHttpRequestLineCRnoLF() {
        ...
        try {
            HttpRequest request = httpParser.parseHttpRequest(generateBadTestCaseRequestLineCRnoLF());
    ...
    @Test
    void parseHttpRequestBadHttpvesrion() {
    ...
    @Test
    void parseHttpRequestUnsupportHttpvesrion() {
    ...
    @Test
    void parseHttpRequestSupportHttpvesrion1() {

        try {
            HttpRequest request = httpParser.parseHttpRequest(generateSupportedHttpversionTestCase1());
    ...
    private InputStream generateBadTestCaseRequestLineCRnoLF(){
        String rawData = "GET / AAAA HTTP/1.1\r" +
                "Accept-Encoding: gzip, deflate, br, zstd\r\n" +
                "Accept-Language: en-US,en;q=0.9\r\n"+
                "\r\n";
